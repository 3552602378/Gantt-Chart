...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `path`, `component`, `icon`, `sort`, `type`, `permission`, `visible`) VALUES
    ...
    (11, 10, '用户管理', '/system/user',     'system/user/index',     'User',       11, 1, NULL,         1),
    ...
    (17, 10, '个人信息', '/system/profile',  'system/profile/index',  'UserFilled', 12, 1, 'user.info',   1);

-- 2.2 计划管理目录
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `path`, `component`, `icon`, `sort`, `type`, `permission`, `visible`) VALUES
    (20, 0,  '计划管理', '/plan',            NULL,                    'Calendar',   20, 0, NULL,          1),
    (21, 20, '计划列表', '/plan/list',       'plan/list/index',       'Tickets',    21, 1, 'plan:list',   1),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `path`, `component`, `icon`, `sort`, `type`, `permission`, `visible`) VALUES
    ...
    (31, 30, '任务列表', '/task/list',       'task/list/index',       'Document',   31, 1, 'task:list',   1),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `path`, `component`, `icon`, `sort`, `type`, `permission`, `visible`) VALUES
    ...
    (41, 40, '甘特视图', '/gantt/view',      'gantt/view/index',      'Histogram',  41, 1, 'gantt:view',  1);
